...
def eval_dataset(dataset_path, width, softmax_temp, opts):
    ...
    model, _ = load_model(opts.model,opts.epochs,opts.finetune_ways,opts.rank,opts.activation_func)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs", type=int, default= None, help="the epochs of the checkpoints")
    ...
    ###Our new added parameters
    parser.add_argument('--finetune_ways', default='normal',help="normal/side_tuning/inside_tuning/lora, \
                        normal is without any additional module, only used in from scratch/ full fine tuning, \
                        side_tuning/inside_tuning/lora is for the other 3 fine tuning ways")
    
    parser.add_argument('--rank',type = int, default=2,help="only effective when finetune_ways is set to lora")

    parser.add_argument('--activation_func', default='tanh',help="tanh/leakyrelu/sigmoid, only effective when finetune_ways is set to inside_tuning")  
